<?php
          ...
          $query=mysqli_query($con,"UPDATE `managemmonday` SET `name`='$name',`description`='$description',`starttime`='$starttime',`endtime`='$endtime' WHERE id='$uid'");
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"><a href="managemmonday.php"><button class="btn btn-primary mr-2"> See Area Head Data Record </button></a></h4>
...
if ($_GET['uid']) {
   # code... 
$a=$_GET['uid'];
$query=mysqli_query($con,"Select * from monday where id = '$a' ");
$cnt=1;
...
<?php }} ?>
<br><br>
<a href="managemmonday.php"><button class="btn btn-primary mr-2">Back</button></a>
